...
const quizDataByTopic = {
    ...
    "پرامپت نویسی": [
        ...
        {"question": "اگر مدل زبانی پاسخهای نامرتبط یا خارج از موضوع میدهد کدام اقدام عملی برای بهبود پرامپت پیشنهاد میشود؟", "correct_answer": "افزودن محدودیتها و دستورالعملهای دقیق تر در پرامپت", "incorrect_answers": ["کوتاه کردن پرامپت و حذف جزئیات اضافی", "استفاده از پرامیتهای باز برای تحریک خلاقیت مدل", "اضافه کردن سوالات فرعی در پرامپت برای راهنمایی بیشتر"]},
    ...
    const lengthConfigGroup = document.getElementById('length-config-group');

    let shuffledQuestions, currentQuestionIndex, score, timerInterval, totalQuestionsInTest;

    // الگوریتم بهینه برای رندوم‌سازی (Fisher-Yates Shuffle)
    ...
    // پر کردن منوی کشویی مباحث به صورت داینامیک
    function populateTopics() {
        topicSelect.innerHTML = '<option value="all">همه مباحث (ترکیبی)</option>';
        for (const topic in quizDataByTopic) {
    ...
    // مدیریت نمایش گزینه‌های تعداد سوالات
    ...
    function showResults() {
        ...
        document.getElementById('score-incorrect').innerText = totalQuestionsInTest - score;
